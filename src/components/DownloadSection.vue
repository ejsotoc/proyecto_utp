        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            ...
            <v-col cols="12" sm="8" class="white--text text-left">
              <h1 class="font-weight-light display-2 mb-2">Documentación en Red</h1>
              <h1 class="font-weight-light">
                Pagina Diseñada para la recolección de documentos encaminados a trámites de las personas privadas 
                de la libertad Qué se encuentran en Establecimientos de reclusión del orden nacional, por parte de familiares
              </h1>
